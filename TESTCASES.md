...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить POST запрос на `/item` с валидными данными
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 201
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить POST запрос на `/item` только с обязательными полями
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 201
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить POST запрос на `/item` без поля `sellerId`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 400
  - Сообщение об ошибке
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить POST запрос на `/item` с sellerId в виде строки
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 400
  - Сообщение об ошибке
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить POST запрос на `/item` с пустым JSON
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 400
  - Сообщение об ошибке
...
- **Шаги**:
  1. Отправить GET запрос на `/item/{itemId}`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 200
...
- **Предусловия**: Создано тестовое объявление
- **Шаги**:
  1. Отправить GET запрос на `/item/{itemId}?fields=additional_field`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 200
  - Данные корректны
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить GET запрос на `/item/1234565`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 404
  - Сообщение об ошибке
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить GET запрос на `/item/abc`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 400
  - Сообщение об ошибке
...
- **Шаги**:
  1. Отправить GET запрос на `/item/seller/{sellerId}`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 200
...
- **Предусловия**: Создано несколько объявлений для одного sellerId
- **Шаги**:
  1. Отправить GET запрос на `/item/seller/{sellerId}?page=1&size=2`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 200
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить GET запрос на `/item/seller/999999`
  2. Проверить ответ
- **Ожидаемый результат**:
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить GET запрос на `/item/seller/abc`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 400
  - Сообщение об ошибке
...
- **Предусловия**: Создано тестовое объявление
- **Шаги**:
  1. Отправить GET запрос на `/item/{itemId}/stats`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 200
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить GET запрос на `/item/999999/stats`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 404
  - Сообщение об ошибке
...
- **Предусловия**: Нет
- **Шаги**:
  1. Отправить GET запрос на `/item/abc/stats`
  2. Проверить ответ
- **Ожидаемый результат**:
  - Status Code: 400
  - Сообщение об ошибке
